...
const Header = (props) => {
	return (
		<header className={props.scrollingClass ? "scrolling" : "none"} id="index-header">
				...
				<ul id="main-navbar">
					...
					<li id="dropdown">
						<div id="dropdown-button">
							<div id="menu-name" className={((props.lunchMenuClass || props.menuClass) ? "active" : "none")}>MENY</div>
				...
				<nav id="hamburger-navbar">
					<ul id="hamburger-main-navbar">
						...
						<li id="hamburger-dropdown" tabIndex="0">
							<div className={((props.lunchMenuClass || props.menuClass) ? "show-hamburger-submenu" : "none")}>
								<div id="hamburger-dropdown-button">
									<div className={((props.lunchMenuClass || props.menuClass) ? "active" : "none")}>MENY</div>
